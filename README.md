...
options:
  ...
  --compose-few-shot-examples
                        [string] How to sample from all classes in few-shot prompting, defaults to "random" (one of "random", "balanced" or a list of class counts for explicit composition)
