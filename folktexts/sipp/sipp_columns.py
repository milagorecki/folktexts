...
sipp_healthdisab = ColumnToText(
    name='HEALTHDISAB',
    short_description="has a physical, mental or other health condition that limits the kind or amount of work he/she can do",
    value_map={
        1.0: "Yes",
        2.0: "No",
    },
...
sipp_qa = MultipleChoiceQA(
    ...
    text="Is this household's income at least three times the poverty threshold based on the Officual Poverty Measure (OPM)?",
    choices=(
